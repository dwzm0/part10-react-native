...
describe('RepositoryList', () => {
    describe('RepositoryListContainer', () => {
      it('renders repository information correctly', () => {
        ...
        expect(firstRepositoryItem).toHaveTextContent(formatInThousands(repositories.edges[0].node.forksCount))
        expect(firstRepositoryItem).toHaveTextContent(formatInThousands(repositories.edges[0].node.stargazersCount))
        ...
        expect(secondRepositoryItem).toHaveTextContent(formatInThousands(repositories.edges[1].node.forksCount))
        expect(secondRepositoryItem).toHaveTextContent(formatInThousands(repositories.edges[1].node.stargazersCount))
